...
export default async function OrdersPage() {
  ...
  const [{ data: orders }, { data: suppliers }, { data: ingredients }] = await Promise.all([
    ...
    selectIngredients(supabase, restaurant!.id, "id, name, unit, pack_price, pack_units, unit_size, pack_quantity, cost_per_base_unit, stock_qty, reorder_threshold, supplier_id, supplier_reference, secondary_unit_label, secondary_unit_size, is_active, suppliers(name), ingredient_suppliers(*)"),
  ]);
